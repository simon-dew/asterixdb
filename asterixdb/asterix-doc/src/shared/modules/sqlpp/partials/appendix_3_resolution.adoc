...
1.  If the identifier matches a variable-name that is in scope, it
...
2.  Otherwise, if the identifier is the first part of a two-part name
...
block.)
2.  (The "Single Variable Rule"): Otherwise, if the FROM clause in the
