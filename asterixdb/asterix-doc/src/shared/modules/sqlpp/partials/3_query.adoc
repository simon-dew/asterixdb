...
[[select-select-returns-an-object-with-a-nested-field-for-each-input-tuple.-each-field-has-as-its-field-name-the-name-of-a-binding-variable-generated-by-either-the-from-clause-or-group-by-clause-in-the-current-enclosing-select-statement-and-its-field-value-is-the-value-of-that-binding-variable.]]
